...
ti8148_ipnc_config	\
ti8148_ipnc_config_nand	\
ti8148_ipnc_config_nand_2g	\
ti8148_ipnc_config_nand_4g	\
ti8148_ipnc_config_nor	\
ti8148_ipnc_config_spi	\
ti8148_ipnc_min_spi	\
ti8148_ipnc_config_sd	\
ti8148_ipnc_config_sd_2g	\
ti8148_ipnc_config_sd_4g	\
ti8148_ipnc_min_uart	\
ti8148_ipnc_min_nand	\
ti8148_ipnc_min_nand_2g	\
ti8148_ipnc_min_nand_4g	\
ti8148_ipnc_min_eth	\
ti8148_ipnc_min_sd	\
ti8148_ipnc_min_sd_2g	\
ti8148_ipnc_min_sd_4g	\
ti8148_ipnc_opti_nand:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI814X"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI814X_IPNC"	>>$(obj)include/config.h
	@if [ "$(findstring _min_,$@)" ] ; then \
		echo "TEXT_BASE = 0x80700000" >> $(obj)board/ti/ti8148_ipnc/config.tmp; \
		echo "#define CONFIG_TI814X_MIN_CONFIG"    >>$(obj)include/config.h ; \
		echo "Setting up TI8148 minimal build for 1st stage..." ; \
		if [ "$(findstring nand,$@)" ] ; then \
			echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			if [ "$(findstring 2g,$@)" ] ; then \
				echo "#define CONFIG_TI814X_DDR3_2Gb"	>>$(obj)include/config.h ; \
			elif [ "$(findstring 4g,$@)" ] ; then \
				echo "#define CONFIG_TI814X_DDR3_4Gb"	>>$(obj)include/config.h ; \
			fi;	\
			echo "TI_IMAGE = u-boot.min.nand" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		elif [ "$(findstring spi,$@)" ] ; then \
			echo "#define CONFIG_SPI_BOOT" >>$(obj)include/config.h;\
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_SPI_BOOT"	>>$(obj)include/config.h ; \
			echo "TI_IMAGE = u-boot.min" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		elif [ "$(findstring uart,$@)" ] ; then \
			echo "#define CONFIG_UART_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_PERIPHERAL_BOOT"	>>$(obj)include/config.h; \
			echo "TI_IMAGE = u-boot.min.uart" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		elif [ "$(findstring eth,$@)" ] ; then \
			echo "#define CONFIG_ETH_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_PERIPHERAL_BOOT"	>>$(obj)include/config.h; \
			echo "TI_IMAGE = u-boot.min.eth" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		elif [ "$(findstring sd,$@)" ] ; then \
			echo "#define CONFIG_SD_BOOT"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			...
			echo "TI_IMAGE = u-boot.min.sd" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		else	\
			echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
	...
	elif	[ "$(findstring _opti_,$@)" ] ; then \
		echo "TEXT_BASE = 0x80700000" >> $(obj)board/ti/ti8148_ipnc/config.tmp; \
		echo "#define CONFIG_TI814X_OPTI_CONFIG"	>>$(obj)include/config.h; \
		echo "TI_IMAGE = u-boot.opti.nand" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
		echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
		echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
		echo "Setting up TI8148 optimal build with ENV in NAND..." ; \
	else	\
		echo "TEXT_BASE = 0x80700000" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		echo "#define CONFIG_TI_DUMMY_HEADER"	>>$(obj)include/config.h; \
		echo "TI_IMAGE = DUMMY" >> $(obj)board/ti/ti8148_ipnc/config.tmp;\
		if [ "$(findstring _nand,$@)" ] ; then \
			echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
			echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
			if [ "$(findstring 2g,$@)" ] ; then \
	...
	@$(MKCONFIG) -a ti8148_ipnc arm arm_cortexa8 ti8148_ipnc ti ti81xx
	
ti8148_ipnc_config_quick_mmc	\
ti8148_ipnc_config_quick_mmc_min:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI814X"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI814X_IPNC"	>>$(obj)include/config.h
	...
	@$(MKCONFIG) -a ti8148_ipnc_quick_mmc arm arm_cortexa8 ti8148_ipnc ti ti81xx	
...
dm385_ipnc_min_sd:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI814X"	>>$(obj)include/config.h
	@echo "#define CONFIG_DM385"	>>$(obj)include/config.h
	@echo "#define CONFIG_DM385_IPNC"	>>$(obj)include/config.h
	@if [ "$(findstring _min_,$@)" ] ; then \
		echo "#define CONFIG_DM385_MIN_CONFIG"    >>$(obj)include/config.h ; \
		echo "Setting up DM385_IPNC minimal build for 1st stage..." ; \
		if [ "$(findstring nand,$@)" ] ; then \
			echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "TI_IMAGE = u-boot.min.nand" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		elif [ "$(findstring spi,$@)" ] ; then \
			echo "#define CONFIG_SPI_BOOT" >>$(obj)include/config.h;\
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_SPI_BOOT"	>>$(obj)include/config.h ; \
			echo "TI_IMAGE = u-boot.min" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		elif [ "$(findstring ocmc,$@)" ] ; then \
			echo "#define CONFIG_UART_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "TEXT_BASE = 0x40310000" >>$(obj)board/ti/dm385_ipnc/config.tmp; \
		elif [ "$(findstring uart,$@)" ] ; then \
			echo "#define CONFIG_UART_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_PERIPHERAL_BOOT"	>>$(obj)include/config.h; \
			echo "TI_IMAGE = u-boot.min.uart" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		elif [ "$(findstring eth,$@)" ] ; then \
			echo "#define CONFIG_ETH_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_PERIPHERAL_BOOT"	>>$(obj)include/config.h; \
			echo "TI_IMAGE = u-boot.min.eth" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		elif [ "$(findstring sd,$@)" ] ; then \
			echo "#define CONFIG_SD_BOOT"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "TI_IMAGE = u-boot.min.sd" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		else	\
			echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		...
		echo "TEXT_BASE = 0x80700000" >> $(obj)board/ti/dm385_ipnc/config.tmp; \
		echo "#define CONFIG_TI814X_OPTI_CONFIG"	>>$(obj)include/config.h; \
		echo "TI_IMAGE = u-boot.opti.nand" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
		echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
		echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
		echo "Setting up DM385 optimal build with ENV in NAND..." ; \
	else	\
		echo "#define CONFIG_TI_DUMMY_HEADER"	>>$(obj)include/config.h; \
		echo "#define CONFIG_SKIP_LOWLEVEL_INIT"	>>$(obj)include/config.h; \
		echo "TI_IMAGE = DUMMY" >> $(obj)board/ti/dm385_ipnc/config.tmp; \
		if [ "$(findstring _nand,$@)" ] ; then \
			echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
			echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
			echo "Setting up DM385_IPNC default build with ENV in NAND..." ; \
		elif [ "$(findstring _nor,$@)" ] ; then \
			echo "#define CONFIG_NOR"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NOR_BOOT"	>>$(obj)include/config.h ; \
			echo "Setting up DM385_IPNC default build with ENV in NOR..." ; \
		elif [ "$(findstring spi,$@)" ] ; then \
			echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
			echo "#define CONFIG_SPI_ENV"    >>$(obj)include/config.h ; \
			echo "Setting up DM385_IPNC default build with ENV in SPI..." ; \
		elif [ "$(findstring sd,$@)" ] ; then \
			echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
			echo "#define CONFIG_MMC_ENV"    >>$(obj)include/config.h ; \
			echo "Setting up DM385_IPNC default build with ENV in MMC..." ; \
		else	\
			echo "#define CONFIG_SYS_NO_FLASH" >> $(obj)include/config.h ; \
			echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
			echo "Setting up DM385_IPNC default build with ENV in NAND..." ; \
	...
	@$(MKCONFIG) -a dm385_ipnc arm arm_cortexa8 dm385_ipnc ti ti81xx

dm385_ipnc_config_quick_mmc	\
dm385_ipnc_config_quick_mmc_min:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"   >>$(obj)include/config.h
	@echo "#define CONFIG_TI814X"   >>$(obj)include/config.h
	@echo "#define CONFIG_DM385"   >>$(obj)include/config.h
	...
	@if [ "$(findstring _min,$@)" ] ; then \
		...
		echo "#define CONFIG_SD_BOOT"    >>$(obj)include/config.h ; \
		echo "TI_IMAGE = u-boot.min.sd" >>$(obj)board/ti/dm385_ipnc/config.tmp; \
		echo "Setting up DM385 IPNC Quick boot minimal build..." ; \
	else    \
		echo "TEXT_BASE = 0x80700000" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		echo "#define CONFIG_TI_DUMMY_HEADER"   >>$(obj)include/config.h; \
		echo "TI_IMAGE = DUMMY" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		echo "Setting up DM385 IPNC Quick boot build..." ; \
	fi;
	@$(MKCONFIG) -a dm385_ipnc_quick_mmc arm arm_cortexa8 dm385_ipnc ti ti81xx	

dm388_ipnc_config	\
dm388_ipnc_config_nand	\
dm388_ipnc_config_nor	\
dm388_ipnc_config_spi	\
dm388_ipnc_config_sd	\
dm388_ipnc_min_ocmc	\
dm388_ipnc_min_uart	\
dm388_ipnc_min_spi	\
dm388_ipnc_min_nand	\
dm388_ipnc_min_eth	\
dm388_ipnc_opti_nand	\
dm388_ipnc_min_sd:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI814X"	>>$(obj)include/config.h
	@echo "#define CONFIG_DM385"	>>$(obj)include/config.h
	@echo "#define CONFIG_DM385_IPNC"	>>$(obj)include/config.h
	@echo "#define CONFIG_DM388_IPNC"	>>$(obj)include/config.h
	@if [ "$(findstring _min_,$@)" ] ; then \
		echo "#define CONFIG_DM385_MIN_CONFIG"    >>$(obj)include/config.h ; \
		echo "Setting up DM385_IPNC minimal build for 1st stage..." ; \
		if [ "$(findstring nand,$@)" ] ; then \
	...
	@$(MKCONFIG) -a dm388_ipnc arm arm_cortexa8 dm385_ipnc ti ti81xx
	
dm388_ipnc_config_quick_mmc	\
dm388_ipnc_config_quick_mmc_min:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"   >>$(obj)include/config.h
	@echo "#define CONFIG_TI814X"   >>$(obj)include/config.h
	@echo "#define CONFIG_DM385"   >>$(obj)include/config.h
	...
	@if [ "$(findstring _min,$@)" ] ; then \
		...
		echo "#define CONFIG_SD_BOOT"    >>$(obj)include/config.h ; \
		echo "TI_IMAGE = u-boot.min.sd" >>$(obj)board/ti/dm385_ipnc/config.tmp; \
		echo "Setting up DM388 IPNC Quick boot minimal build..." ; \
	else    \
		echo "TEXT_BASE = 0x80700000" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		echo "#define CONFIG_TI_DUMMY_HEADER"   >>$(obj)include/config.h; \
		echo "#define CONFIG_MMC_ENV"    >>$(obj)include/config.h ; \
		echo "TI_IMAGE = DUMMY" >> $(obj)board/ti/dm385_ipnc/config.tmp;\
		echo "Setting up DM388 IPNC Quick boot build..." ; \
	fi;
	@$(MKCONFIG) -a dm388_ipnc_quick_mmc arm arm_cortexa8 dm385_ipnc ti ti81xx	
